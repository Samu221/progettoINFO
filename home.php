...
<body>
    <header>
        ...
        <a href="inserimento.html" class="aggiungi-link">
            <img src="immagini/aggiungi.png" alt="Icona Aggiungi" style="width: 40px;">
        </a>
    </header>
    ...
    $sql = "SELECT progetto.CODICE, progetto.titolo, progetto.ambito, progetto.descrizione, immagine.immagine, progetto.username_creatore
            FROM progetto
